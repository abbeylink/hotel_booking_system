...
import com.abiodunyekeen.hotelbooking.exception.RoleAlreadyExistException;
...
public class RoleService implements IRoleService {
    ...
    @Transactional
    public void checkAndInsertRoles() {
        insertRoleIfNotExist("ROLE_ADMIN");
        insertRoleIfNotExist("ROLE_USER");
    }

    private void insertRoleIfNotExist(String roleName) {
